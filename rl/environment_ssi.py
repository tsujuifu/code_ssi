...
class GymEnvironment(object):
    def __init__(self, args, gamma):
        ...
        self.sv = pickle.load(open('./data/ssi.pkl', 'rb'))
        self.cid = -1
    ...
    def new_game(self, from_random_game=False):
        ...
        self.cid = (self.cid+1) % (len(self.sv))
        st = self.sv[self.cid][0]
        self.env.restore_full_state(st)
    ...
    def new_expt(self):
        ...
        self.task = TaskSelf(self)
        self.chg_language_network()
    ...
    def chg_language_network(self):
        self.lang = self.sv[self.cid][2]
